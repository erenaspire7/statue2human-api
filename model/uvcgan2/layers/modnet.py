...
from model.uvcgan2.utils import get_activ_layer, get_upsample_x2_layer

from model.uvcgan2.layers.unet import UNetEncBlock
...
class ModNetDecBlock(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.upsample, input_features = get_upsample_x2_layer(upsample, input_features)
...
class ModNetBlock(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.conv = UNetEncBlock(features, activ, norm, downsample, image_shape)
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.conv_block1 = ModulatedConv2d(
            in_features, mid_features, kernel_size=3, padding=1, demod=demod
        )
        ...
        self.conv_block2 = ModulatedConv2d(
            mid_features, out_features, kernel_size=3, padding=1, demod=demod
        )
...
class ModNet(nn.Module):
    ...
    def _construct_input_layer(self, activ):
        self.layer_input = nn.Sequential(
            nn.Conv2d(
                self.image_shape[0], self.features_list[0], kernel_size=3, padding=1
            ),
...
class StyleBlock(nn.Module):
    ...
    def __init__(self, mod_features, style_features, rezero=True, bias=True, **kwargs):
        super().__init__(**kwargs)
